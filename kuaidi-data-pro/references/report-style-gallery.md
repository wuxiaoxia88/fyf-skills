...
除以上5种通用风格外，还提供8种中国快递企业品牌风格，适用于快递物流行业报告。

完整规范 → `courier-brand-styles.md`

| 企业 | 核心色 | 气质 | 最适场景 |
|------|-------|------|---------|
| 中通 ZTO | 双蓝 `#0055B8` + `#5DC8F0` | 科技信赖 | 行业分析 |
| 圆通 YTO | 紫橙 `#6A1FA2` + `#E63B2B` | 青年活力 | 市场报告 |
| 申通 STO | 橙灰 `#FF6600` + `#4A4A4A` | 温暖亲和 | 运营报告 |
| 韵达 Yunda | 黄黑 `#FFC300` + `#1A1A1A` | 高辨识 | 数据看板 |
| 极兔 J&T | 红白 `#E60012` + `#FFFFFF` | 国际极简 | 战略报告 |
| 顺丰 SF | 红黑 `#E60012` + `#1A1A1A` | 高端领导 | 管理层汇报 |
| 京东 JDL | 京东红 `#CC1111` | 科技温度 | GMV分析 |
| 中国邮政 | 邮政绿 `#008F3D` + `#78BE20` | 国家权威 | 政策报告 |
