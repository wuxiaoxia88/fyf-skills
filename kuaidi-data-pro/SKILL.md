...
当用户提到企业名（如"顺丰风格"、"中通风格"）或"快递/物流品牌风格"时使用对应企业风格。未指定时仍从上方5种通用风格中随机选择。

| 企业 | 色彩体系 | 标志元素 | 最适场景 |
|------|---------|---------|---------|
| 中通 ZTO | 深蓝+浅天蓝 | 蓝色渐变条 + 科技感 | 行业分析、技术报告 |
| 圆通 YTO | 紫+橙红撞色 | 紫橙大胆对比 | 业务复盘、市场报告 |
| 申通 STO | 橙+深灰 | 橙色顶线 + 温暖卡片 | 运营报告、客户汇报 |
| 韵达 Yunda | 黄+黑 | 黄色进度条 + 暗色看板 | 数据看板、周报月报 |
| 极兔 J&T | 红+白极简 | 极简留白 + 国际化 | 国际业务、战略报告 |
| 顺丰 SF | 红+黑强对比 | 黑底红字 + 高端感 | 管理层汇报、年度报告 |
| 京东物流 JDL | 京东红+渐变 | 红色大色块 + 科技温度 | GMV分析、电商物流 |
| 中国邮政 | 邮政绿双色 | 深浅绿层次 + 国家权威 | 政策报告、行业白皮书 |

快递企业风格的完整规范 → `references/courier-brand-styles.md`
...
| 快递企业品牌风格库（中通/圆通/申通/韵达/极兔/顺丰/京东/邮政） | `references/courier-brand-styles.md` |
...
> **快递大师出品** | 从快递员到网点老板到AI开发者
> 公众号「快递大师」| 15年一线经验 | 只做快递人用得上的AI工具
> 代表作：网点自动化流程工具包 · 《快递老板的AI效率革命》
